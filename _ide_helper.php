...
namespace Illuminate\Support\Facades {
     ...
     * @method static \Illuminate\Http\Client\Response|PromiseInterface get(string $url, array|string|null $query = null)
     * @method static \Illuminate\Http\Client\Response|PromiseInterface head(string $url, array|string|null $query = null)
     * @method static \Illuminate\Http\Client\Response|PromiseInterface post(string $url, array $data = [])
     * @method static \Illuminate\Http\Client\Response|PromiseInterface patch(string $url, array $data = [])
     * @method static \Illuminate\Http\Client\Response|PromiseInterface put(string $url, array $data = [])
     * @method static \Illuminate\Http\Client\Response|PromiseInterface delete(string $url, array $data = [])
     * @method static array pool(callable $callback)
     * @method static \Illuminate\Http\Client\Response|PromiseInterface send(string $method, string $url, array $options = [])
     ...
     * @method static PendingRequest|mixed when((\Closure(\Illuminate\Http\Client\PendingRequest): mixed)|mixed $value = null, (callable(\Illuminate\Http\Client\PendingRequest, mixed): mixed)|null $callback = null, (callable(\Illuminate\Http\Client\PendingRequest, mixed): mixed)|null $default = null)
     * @method static PendingRequest|mixed unless((\Closure(\Illuminate\Http\Client\PendingRequest): mixed)|mixed $value = null, (callable(\Illuminate\Http\Client\PendingRequest, mixed): mixed)|null $callback = null, (callable(\Illuminate\Http\Client\PendingRequest, mixed): mixed)|null $default = null)
